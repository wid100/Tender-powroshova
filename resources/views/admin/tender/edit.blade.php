                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="contact_details" id="tinymceExample3" rows="5">{!! $tender->contact_details !!}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="description" class="form-label">Description</label>
                                        <textarea class="form-control" name="description" id="tinymceExample" rows="5">{!! $tender->description !!}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="condition" class="form-label">Condition</label>
                                        <textarea class="form-control" name="condition" id="tinymceExample2" rows="5">{!! $tender->condition !!}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
