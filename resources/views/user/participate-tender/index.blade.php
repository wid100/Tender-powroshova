    ...
    <section class="in-tender">
            <div class="tender-interface">
              ...
              <div class="selection-bar">
                ...
                <div
                  class="tab-content live-table-wrapper mt-4"
                  id="myTabContent"
                >
                  <div
                          ...
                          <div class="col-md-12">
                            <div class="form-input-item">
                              ...
                              <input
                                ...
                                placeholder="Tender Ref No"
                                value="BPD/2024/RFQ-565"
                                required
                              />
                            </div>
                          </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-input-item">
                              ...
                              <input
                                ...
                                value="RFQ for Camera and SD Memory Card. [BPD/2024/RFQ-617]"
                                required
                              />
                            </div>
                          </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-input-item">
                              <label
                                class="tender-form-header"
                                for="validationCustom01"
                                >Tender Payment Details</label
                              >
                              <div class="table-responsive">
                                <table
                                  class="table participate-tender-table table-hover"
                                >
                    ...
                    <form action="">
                      <div class="tender-item-details-wrapper">
                        ...
                        <div class="table-responsive">
                          <table
                            id="myTable"
                            class="table participate-table table-hover"
                          >
                            <thead class="tender-table-header">
                              <tr>
                          ...
                          <table class="table participate-table table-hover">
                            <thead class="tender-table-header">
                              <tr>
                                <th
                                  scope="col"
                                  class="particate-title-text w-25"
                                >
                                  Document Title
                                </th>
                  ...
                  <div
                    ...
                    id="submit-offer"
                    role="tabpanel"
                    aria-labelledby="submit-offer-tab"
                  >
                    <form action="">
                      <div class="tender-item-details-wrapper mt-3">
                        <h2 class="table-text-list">
                            ...
                            <tbody class="tender-table-body">
                              <tr>
                                ...
                                <td>
                                  <div class="upload-img custom-btn">
                                    <img
                                      src="/assets/images/icons/tk-icon.svg"
                                      alt=""
                                    />
                                  </div>
                                </td>
